...
class SecurityValidator:
    ...
    @classmethod
    def validate_file_size(cls, file_size: int, max_size: int | None = None) -> bool:
        """
    ...
    def validate_numeric_range(
        cls, value: int | float, min_val: float | None = None, max_val: float | None = None
    ) -> bool:
        """
    ...
    def verify_password(cls, password: str, password_hash: str) -> bool:
        ...
        try:
            ...
            if len(parts) == 2:
                salt_str, hash_value = parts
                computed = hashlib.sha256((password + salt_str).encode()).hexdigest()
    ...
    def check_file_security(
        cls, filename: str, file_size: int, content_type: str | None = None
    ) -> dict:
        """
        ...
        """
        result: dict[str, Any] = {"safe": True, "errors": [], "warnings": []}
...
class PermissionChecker:
    ...
    def can_access_module(user_role: str, module: str) -> bool:
        ...
        module_access = {
            ...
            "user": ["empleados", "documentos", "incidencias", "asistencia"],
