        ...
        errores = IncidenciaValidator.validate_datos_incidencia(
            {
                ...
                "fecha_fin": "02/01/2026",
                "motivo": "M",
                "dias_solicitados": 400,
            }
        )
        assert any("365" in e for e in errores)

    def test_dias_solicitados_no_entero_reporta_error(self):
        # Los valores no convertibles para días se reportan como error
        # (antes se ignoraban en silencio y fallaban al persistir)
        errores = IncidenciaValidator.validate_datos_incidencia(
            {
                "empleado_id": 1,
                "tipo_incidencia": "permiso",
        ...
        errores = PagoValidator.validate_datos_pago(
            {
                "empleado_id": 1,
                "tipo_pago": "mensual",
                "periodo_inicio": "31/01/2026",
                "periodo_fin": "01/01/2026",
                "salario_base": 1500.0,
            }
        )
        assert any("anterior a la fecha inicio" in e for e in errores)
