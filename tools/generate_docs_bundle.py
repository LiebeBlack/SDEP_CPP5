...
DOCUMENTS_MANIFEST = [
    ...
    {
        "id": "tesis-registro-control",
        "file": "TESIS/REGISTRO_CONTROL_DOCUMENTAL.md",
        "title": "Registro de Control Documental",
        "subtitle": "Historial de versiones, inventario documental, verificaciones practicadas y evidencia pendiente.",
        "category": "Tesis Académica",
        "order": 10,
        "badge": "Control",
        "icon": "🗃️",
    ...
    {
        "id": "tesis-resumen-investigacion",
        "file": "TESIS/RESUMEN_INVESTIGACION.md",
        "title": "Resumen de la Investigación",
        "subtitle": "Documento autónomo de síntesis con resultados verificables y relación de archivos de respaldo.",
        "category": "Tesis Académica",
        "order": 11,
        "badge": "Resumen",
        "icon": "📄",
    ...
    {
        "id": "tesis-oficio-anexos",
        "file": "TESIS/OFICIO_1_PRESENTACION_ANEXOS.md",
        "title": "Oficio de Presentación: Compendio y Anexos",
        "subtitle": "Comunicación formal que integra el compendio del proyecto sociotecnológico y los diez anexos.",
        "category": "Tesis Académica",
        "order": 12,
        "badge": "Oficio",
        "icon": "📨",
    ...
    {
        "id": "tesis-oficio-resumen",
        "file": "TESIS/OFICIO_2_PRESENTACION_RESUMEN.md",
        "title": "Oficio de Presentación: Resumen y Archivos Definitivos",
        "subtitle": "Comunicación formal que presenta el resumen de la investigación y los archivos definitivos.",
        "category": "Tesis Académica",
        "order": 13,
        "badge": "Oficio",
        "icon": "📨",
